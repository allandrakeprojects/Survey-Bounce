...
Route::get('/cashout', 'HomeController@cashout')->name('cashout');
Route::get('/cashout/certify', 'HomeController@cashout_certify')->name('cashout.certify');
Route::get('/cashout/error', 'HomeController@cashout_error')->name('cashout.error');
