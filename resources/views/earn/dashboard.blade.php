...
@section('content')
    <div class="container">
        <div class="alert">
            <span class="closebtn" onclick="this.parentElement.style.display='none';">×</span><b>$165.00</b> paid <b id="secs">1 minute</b> ago to @* via Bitcoin</div>
        <script>
        ...
        <div id="sm" class="c-card">
            <p><span style="color: red;">🎉Happy New Year! 🎉</span> For a limited time, clicks are now <b>$5</b> and referrals are now <b>$20-25!</b>. Don't miss out! <br><b>Now until January 30th!</b></p>
        </div>
        <div id="sm" class="c-card">
            <p><span style="color: green;">💰NEW $25 Review Wall 💰</span> We just launched our NEW Review wall. Get paid to read reviews &amp; blogs! Earn up to $50 per read/review. <a href="reviewwall.php">GET STARTED!</a></p>
        </div>
        ...
        <div style="margin-top: 15px;" class="row">
          ...
          <br>
                    ...
                    <!--    <p><i class="fas fa-exclamation-circle" style="margin-right: 3px;"></i>Our share link currently doesn't work for Facebook, Instagram, & WhatsApp. Please refer your friends using Twitter, iMessage, etc for now. We are working on resolving this issue.</p> --> </div>
            </div>
            <div class="col-md-6 col-xl-6">
                <a href="/dashboard/taskwall.php"><div class="c-card tw-card">
                        <h3 style="text-align: center;color: #fff; font-size: 25px; font-weight: 600;">$50 SURVEYS &amp; APPS</h3>
                    </div>
                </a>
            </div>
        </div>
        <div id="fraudcard" class="c-card">
            ...
            <p><i class="fas fa-exclamation-triangle" style="color:red;"></i><span style="color: red;">WARNING!</span> When confirming payments, if our team finds any <b>fake referrals/clicks</b>, your account will be <b>banned</b> and your payment will not be approved. <br><a target="_blank" href="https://tap2earn.co/fraud-policy">Fraud Policy</a></p>
            <center><button id="fraudaccept" class="btn btn-primary" style="background-color: red;width: 50%;margin-top: 10px;border-radius: 30px;">OK, I accept</button></center>
        </div>
...
<a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://share.tap2earn.co/ahmedshabbirawan&amp;quote=COME JOIN Tap 2 Earn, a site that lets you earn money with social media. I earned $25 and you can too! Sign up today for a $25 bonus! https://share.tap2earn.co/ahmedshabbirawan" class="btn btn-primary btn-lg">
Share Link</a></span>
                            </li>
...
<a target="_blank" href="whatsapp://send?text=I'm inviting you to join Tap 2 Earn, a site that lets you earn money with social media. I just earned $25 and you can too! Sign up today for a $25 bonus! https://share.tap2earn.co/ahmedshabbirawan" class="btn btn-primary btn-lg">
Share Link</a></span>
                            </li>
...
<a target="_blank" href="https://twitter.com/intent/tweet?url=https://share.tap2earn.co/ahmedshabbirawan;text=COME JOIN Tap 2 Earn, a site that lets you earn money with social media. I earned $25 and you can too! Sign up today for a $25 bonus!;hashtags=onlinejob+%23earnmoney+%23makemoneyonline" class="btn btn-primary btn-lg">
Share Link</a></span>
                            </li>
